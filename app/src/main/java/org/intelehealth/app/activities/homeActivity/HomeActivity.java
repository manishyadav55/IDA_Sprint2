...
import org.intelehealth.app.activities.myActivity.DoctorList;
import org.intelehealth.app.activities.myActivity.PerformanceDashboard;
...
//        c1 = findViewById(R.id.cardview_newpat);
        ...
        c7 = findViewById(R.id.performancedashboard);
...
//        manualSyncButton.setText(R.string.refresh);
        ...
        c7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HomeActivity.this, PerformanceDashboard.class);
                startActivity(intent);
            }
        });
